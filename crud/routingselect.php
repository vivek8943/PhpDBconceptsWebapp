      ...
      <div class="content">
        ...
        <div class="cont span_2_of_3">
           <h2 >Select Product</h2>
                <form name='f1' align='center'class="form-inline" role="form" action='routing.php' onsubmit="return validation();"method='post'>  <form align='center'class="form-inline" name='f1'role="form" action='routing.php' method='post'>
