...
<body>
  <div class="header">
		 <div class="header_top">
              ...
              <li class="active"><a href="routingselect.php">Routing</a></li>
				...
				<div class="cont span_3_of_3">
		              ...
		              <thead>
		                <tr>
		                  <th>Product ID</th>
		                   <th>Description</th>
		                  <th>Operation Seq No</th>
		                  <th>Operation Description</th>
		                  <th>WorkCenter Location</th>
		                  <th>Setup Time</th>
		                  <th>StandardOperation Time</th>
...
$disp1=date_format($date1, 'Y-m-d H:i:s');
  $date2 = date_create('2000-02-01');
  $disp2= date_format($date2, 'Y-m-d H:i:s');
...
while($row = sqlsrv_fetch_array($query))
{
   ...
   #$row6 =$row[6];
   # $string=$row[6]->format('Y-m-d H:i:s');
   //$date1 = sqlsrv_get_field( $row6, 0, SQLSRV_PHPTYPE_STRING("UTF-8"));
